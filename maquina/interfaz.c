...
void dibujaInterfazM3()
{
    ...
    printf(" M Á Q U I N A   E N I G M A M3");
    setlocale(LC_CTYPE,"C");
    for(i=0; i<25; i++)
        printf("%c",205);
    printf("%c",187);
...
void dibujaInterfazM4()
{
    ...
    setlocale(LC_CTYPE,"Spanish");
    printf(" M Á Q U I N A   E N I G M A M4");
    setlocale(LC_CTYPE,"C");
    for(i=0; i<29; i++)
        printf("%c",205);
    printf("%c",187);
...
void 	muestraEsquema (struct sEnigma enigma, struct sPunto coordRotor[])
{
    ...
    if(enigma.config.numRotores==4) /**SI HAY 4 ROTORES LO DIBUJA DE UNA FORMA(COLOCANDO EL 4 ROTOR EN LA PRIMERA POSICION)*/
    {
    ...
    {
        for(i=0; i<enigma.config.numRotores; i++)/**SI HAY 3 ROTORES LO DIBUJA DE OTRA FORMA*/
        {
...
void dibujaEstator(unsigned short dx)
{
    ...
    int i, y=5;
    for(i=0; i<26; i++)/*DIBUJO EL ESTATOR*/
    {
        gotoxy(32+dx,y);
        printf("%c",i+65);
        y++;
...
void dibujaStecker(char stecker[], unsigned short dx)
{
    ...
    int i, y=5;
    for(i=0; i<26; i++) /*DIBUJO EL RECUADRO STECKER*/
    {
        gotoxy(36+dx,y);
        printf("%c",i+65);
        gotoxy(39+dx,y);
