...
void procesoCifrado(struct sEnigma pEnigma) {
    ...
    /*BUCLE QUE SE REPITE MIENTRAS NO SE PULSE LA TECLA ESCAPE Y SOLO LEE CARACTERES ALFABETICOS*/
    do {
        do {
            ...
            if(tecla==27)
                salida=27;
        /*SE REPITE MIENTRAS LA TECLA PULSADA NO SEA ALFABETICA O EL ESCAPE*/
        } while(tecla == -1); 
        /*SI LA TECLA ESCAPE ES PULSADA, SALIDA TOMA VALOR DE 27 Y SALE DEL BUCLE*/
        if(salida == 27)
            break;
        ...
        /*MENSAJE DE ALERTA SI EL MENSAJE EXCEDE LAS 250 LETRAS*/
        if(contadorTexto==250) {
            salida = 27;
        ...
        /*SE CAMBIA LA TECLA PULSADA POR SU PAREJA EN EL STECKER*/
        ...
        /*ESTE COMANDO ES UNA FUNCION CREADA POR MI EN AUXILIAR.C PARA DIBUJAR LAS LINEAS*/
        ...
        /*SE CAMBIA LA TECLA DEVUELTA POR STECKER POR SU PAREJA EN EL PRIMER ROTOR*/
        tecla = opRotor(posIn, pEnigma.listaRotores.rotor[2],0);
        posIn = tecla;
        destino[1] = posIn;
        ...
        /*SE CAMBIA LA TECLA DEVUELTA POR EL PRIMER ROTOR POR SU PAREJA EN EL SEGUNDO ROTOR*/
        tecla=opRotor(posIn, pEnigma.listaRotores.rotor[1],0);
        posIn=tecla;
        ...
        /*SE CAMBIA LA TECLA DEVUELTA POR EL SEGUNDO ROTOR POR SU PAREJA EN EL TERCER ROTOR*/
        tecla = opRotor(posIn, pEnigma.listaRotores.rotor[0],0);
        posIn = tecla;
        ...
        if(pEnigma.config.numRotores==4) {
            ...
            /*SE CAMBIA LA TECLA DEVUELTA POR EL TERCER ROTOR POR SU PAREJA EN EL CUARTO ROTOR*/
            tecla = opRotor(posIn, pEnigma.listaRotores.rotor[3],0);
            posIn = tecla;
        ...
        if(pEnigma.config.numRotores == 4) {
            ...
            /*SE CAMBIA LA TECLA DEVUELTA POR EL REFLECTOR POR SU PAREJA EN EL CUARTO ROTOR*/
            tecla = opRotor(posIn, pEnigma.listaRotores.rotor[3],1);
            posIn = tecla;
        ...
        /*SE CAMBIA LA TECLA DEVUELTA POR EL REFLECTOR (o el 4 rotor) POR SU PAREJA EN EL PRIMER ROTOR*/
        tecla = opRotor(posIn, pEnigma.listaRotores.rotor[0],1);
        posIn = tecla;
        ...
        /*SE CAMBIA LA TECLA DEVUELTA POR EL PRIMER ROTOR POR SU PAREJA EN EL SEGUNDO ROTOR*/
        tecla = opRotor(posIn, pEnigma.listaRotores.rotor[1],1);
        posIn = tecla;
        ...
        /*SE CAMBIA LA TECLA DEVUELTA POR EL SEGUNDO ROTOR POR SU PAREJA EN EL TERCER ROTOR*/
        tecla = opRotor(posIn, pEnigma.listaRotores.rotor[2],1);
        posIn = tecla;
        ...
        x++;
        /*SE REPITE MIENTRAS LA TECLA PULSADA NO SEA EL ESC*/
    } while(salida != 27);

    /*CIERRA LOS FICHEROS*/
    cierraArchivosMensaje(ptPlano1, ptCifrado1);
...
/*ABRE MENSAJEPLANO.TXT Y MENSAJECIFRADO.TXT Y SALTA UNA ALERTA SI HAY PROBLEMAS EN LA APERTURA DE LOS FICHEROS*/
...
char leeLetra(unsigned short dx) {
    ...
    gotoxy(63 + dx,2);
    letra=getch();
    /*LEE POR TECLADO UNA LETRA, SI ES MINUSCULA LA CONVIERTE A MAYUSCULA Y SI NO ES UN CARACTER NUMERICO DEVUELVE -1*/
